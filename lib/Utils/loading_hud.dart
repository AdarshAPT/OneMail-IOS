...
class FetchingIndicator extends StatefulWidget {
  ...
  static _FetchingIndicatorState? of(BuildContext context) {
    final progressHudState =
        context.findAncestorStateOfType<_FetchingIndicatorState>();
  ...
  @override
  _FetchingIndicatorState createState() => _FetchingIndicatorState();
}
